...
public class MenuBar extends JMenuBar {
                ...
                new Thread(() -> {
                    try {
                        ...
                        SwingUtilities.invokeLater(() -> {
                            JOptionPane.showMessageDialog(Window.getCurrentInstance()
                                            .getFrame(), "Current scene has been saved successfully", "Success",
                        ...
                        SwingUtilities.invokeLater(() -> {
                            JOptionPane.showMessageDialog(Window.getCurrentInstance()
                                            .getFrame(), "Could not save current Scene: " + e1.getMessage(), "Error",
            ...
            if (file != null) {
                new Thread(() -> {
                    try {
                        ...
                        SwingUtilities.invokeLater(() -> {
                            JOptionPane.showMessageDialog(Window.getCurrentInstance()
                                            .getFrame(), "New scene has been loaded successfully", "Success",
                                    JOptionPane.INFORMATION_MESSAGE);
                        });
                    } catch (IOException e1) {
                        SwingUtilities.invokeLater(() -> {
                            JOptionPane.showMessageDialog(Window.getCurrentInstance()
                                            .getFrame(), "Could not load new Scene: " + e1.getMessage(), "Error",
                                    JOptionPane.ERROR_MESSAGE);
                        });
                        e1.printStackTrace();
                    }
    ...
    private File getFile(boolean ensureExtension) {
        ...
        fileChooser.showDialog(Window.getCurrentInstance()
                .getFrame(), "Select");
        ...
        while (true) {
            ...
            while ((file = fileChooser.getSelectedFile()) == null) {
                int choice = JOptionPane.showConfirmDialog(Window.getCurrentInstance()
                                .getFrame(), "Do you want to cancel the current operation?", "Abort action",
            ...
            try {
                ...
                if (ensureExtension) {
                    String[] fileNameParts = file.getName()
                            .split("\\.");
                ...
                try {
                    PropertyManager.set("path", fileChooser.getCurrentDirectory()
                            .getAbsolutePath());
                ...
                JOptionPane.showMessageDialog(Window.getCurrentInstance()
                                .getGameDisplay(), "An unexpected error occured. Please try again.", "Invalid File",
                        JOptionPane.ERROR_MESSAGE);
                continue;
            }
        }
